...
<div class="content">
    <nav>
        <h2>Staff Menu</h2>
        <a class="admin_menu" href="<?php echo url_for("/user_staff/invoices/index.php"); ?>">Invoices</a><br>
        <a class="admin_menu" href="<?php echo url_for("/user_staff/inventory/index.php"); ?>">Inventory</a>
